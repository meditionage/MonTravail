...
\frontmatter 
%Seitenzahlzähler wird auf 3 gesetzt, da Titelseiten nicht mitgezählt werden
\setcounter{page}{3}
...
\include{kapitel/Preface} 	%in jedem Kapitel die Nummerierung neu beginnt
	...
	\include{kapitel/Introduction} 	%in jedem Kapitel die Nummerierung neu beginnt
